...
import { Menu, X } from 'lucide-react'; // If using lucide-react or swap for inline SVG
...
<header className="fixed top-0 left-0 w-full z-50 bg-black/50 backdrop-blur-sm shadow">
  ...
  {mobileOpen && (
    <motion.div
      ...
      className="md:hidden bg-black/80 text-white px-6 py-4 space-y-4"
    >
    ...
    {/* ABOUT */}
    <section id="about" className="px-6 py-20 bg-gray-800 text-center text-gray-300">
    ...
    <section id="contact" className="px-6 py-20 text-center">
      ...
      <div className="flex justify-center gap-6 text-xl">
        <a href="https://github.com/yersin13" target="_blank" className="hover:text-blue-400">
          GitHub
        </a>
        <a
          href="https://www.linkedin.com/in/yersin-hernandez/"
          target="_blank"
          className="hover:text-blue-400"
        >
          LinkedIn
        </a>
        {/* Optional: add email or form */}
        {/* <a href="mailto:yersineduard@gmail.com" className="hover:text-blue-400">
          Email
        </a> */}
      </div>
    </section>
